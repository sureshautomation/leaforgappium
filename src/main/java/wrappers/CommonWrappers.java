...
//			new TouchAction<>(driver).press(PointOption.point(startX, startY)).waitAction(WaitOptions.waitOptions(Duration.ofSeconds(2))).moveTo(PointOption.point(endX, endY)).release().perform();
	...
	public void pinchUsingPointerInput() {
		...
		pinchAndZoom1.addAction(finger.createPointerMove(Duration.ofSeconds(2), PointerInput.Origin.viewport(),
		...
		pinchAndZoom2.addAction(finger2.createPointerMove(Duration.ofSeconds(2), PointerInput.Origin.viewport(),
				source.x / 2, source.y / 2));
	...
	public boolean scrollFromDownToUpinAppUsingPointerInput() {
		Dimension size = driver.manage().window().getSize();
		int startX = (int) (size.getWidth() * 0.5);
		int startY = (int) (size.getHeight() * 0.8);
		int endX = (int) (size.getWidth() * 0.5);
	...
	public boolean scrollFromUpToDowninAppUsingPointerInput() {
		Dimension size = driver.manage().window().getSize();
		int startX = (int) (size.getWidth() * 0.5);
		int startY = (int) (size.getHeight() * 0.2);
		int endX = (int) (size.getWidth() * 0.5);
	...
	public boolean scrollFromRightToLeftInAppUsingPointerInput() {
		Dimension size = driver.manage().window().getSize();
	...
	public boolean scrollFromLeftToRightInAppUsingPointerInput() {
		Dimension size = driver.manage().window().getSize();
	...
	public boolean scrollFromUpToDowninAppWithWebElementUsingTouchActions(WebElement ele) {
	...
	public boolean scrollFromUpToDowninAppWithWebElementUsingPointerInput(WebElement ele) {
	...
	public boolean scrollFromDownToUpinAppWithWebElementUsingPointerInput(WebElement ele) {
	...
	public boolean scrollFromLeftToRightinAppWithWebElementUsingPointerInput(WebElement ele) {
	...
	public boolean scrollFromRightToLeftinAppWithWebElementUsingPointerInput(WebElement ele) {
